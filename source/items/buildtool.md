...
The first step is to craft the build tool. You will also get a build tool in the [Supply Camp or Ship](../../source/items/supplycampandship). It is in the same rack as the [Town Hall](../../source/buildings/townhall).
<br>

### Step Two

To place a worker hut or a build from the mod, you first need to have the hut block for the build you want in your inventory. Then, using the build tool, you can right click on the block where you want to place it. The GUI will pop up where you have many options:
