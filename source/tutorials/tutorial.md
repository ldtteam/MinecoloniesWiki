...
Your first step to start your town is placing the [Town Hall] Chest. While it can be placed manually, it is far better to place the Town Hall using the [Building Tool](https://www.youtube.com/watch?v=DVGGDUXbTOY) you obtained from your supply chest. The Buiding Tool will help you place your buildings, and using it will show you a 3D ghost outline of what the building will look like.
...
![alt text](../../assets/images/gui/Next_Colony_1.png)

![alt text](../../assets/images/gui/Players_Colony_1.png)

![alt text](../../assets/images/gui/No_Colony_1.png)
