...
<div class="row">
  ...
  <div class="col-sm-12 col-md">
    ...
    <ul>
      ...
      <li><strong>Build Options-</strong>to create a build, upgrade, reposition, or repair build order for the Citizen Hut. To learn more about the building system, please see the [Builder](../../source/workers/builder) page.</li>
