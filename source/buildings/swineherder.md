...
<div class="row">
  ...
  <div class="col-sm-12 col-md">
    ...
    <ul>
      ...
      <li><strong>Inventory:</strong> Here you can access the hut block's storage, where the Swine Herder takes their materials and deposits their meat. They will also use any racks or chests in the hut, so be sure to check those as well!</li>
    </ul>
  </div>
</div>
  <br>
