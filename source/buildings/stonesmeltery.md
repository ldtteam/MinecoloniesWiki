...
The Stone Smeltery is where the Stone Smelter will smelt cobblestone into stone, stone bricks into cracked stone bricks, clay balls into bricks, clay blocks into terracotta, and sandstone into smooth sandstone. The Stone Smelter will only work when they receive a request from another worker and have the needed materials. You will also need to teach the Stone Smeltery the recipes you want the Stone Smelter to craft.

**Hint:** Upgrading the Stone Smeltery lets you teach it more recipes. So:
