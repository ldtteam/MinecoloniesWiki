...
<div class="row">
  ...
  <div class="col-sm-12 col-md">
    ...
    <ul>
     <li><strong>Build Options- </strong> The button will say; "Build Options" ** See Note at the bottom of this page.</li>
     <li><strong>Citizen Recruitment - </strong>This is where you can recruit adult citizens to join your colony.</li>
...
---
<p><strong>Citizen Recruitment: </strong>This is the option from the Actions page, where you can recruit adult citizens:</p>

<div class="row">
  <div class="col-sm-12 col-md">
    <img src="../../assets/images/gui/citizenrecruitmentgui.png" class="img-fluid mx-auto" alt="Citizen Recruitment Option">
  </div>
  <div class="col-sm-12 col-md">
    <p><strong>Title </strong>Choose which recruitment package you want to send. Citizen stats increase from Hay - Books - Emeralds To Diamond. Using one package increases the price of all with each purchase.</p>
    <ul>
     <li><strong>Hay - </strong> This is the lowest and cheapest option and will likely result in a citizen with all skills at 1.</li>
     <li><strong>Book - </strong>This is the next highest option and will likely result in a citizen with low skill levels, possibly some level 1 skills.</li>
     <li><strong>Emerald - </strong>This is the 3rd highest option and will likely result in a citizen with mid range skills.</li>
     <li><strong>Diamond - </strong>This is the highest and most expensive option and should result in a new citizen with fairly high level skills.</li>
    </ul>
  </div>
</div>  
