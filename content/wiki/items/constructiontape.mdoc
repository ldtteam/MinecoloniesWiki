...
Construction tape is a unique item that automatically generates when a building is placed. It can be crafted at the {% building_link sawmill %} or by the player for use as decoration.
<br>
...
#### For more information on the build system, please see the {% worker_link builder %} page.
