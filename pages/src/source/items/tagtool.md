...
* Building-specific tags
    ...
    | `cobble` | Mine | Always 1 | The block behind the top-most ladder at the start of the mineshaft (traditionally cobble, but may be something else) |
    ...
    | `work`   | Archery     | level-based | The block the archer squire stands on to shoot the targets (if no tags are used, they look for glowstone) |
