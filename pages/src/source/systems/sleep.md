...
{% building_link house %} and {% building_link tavern %} provide most of your colonists with bedspaces to sleep in. If set in the {% building_link townhall %}, you can manually assign colonists to beds in Houses or the Tavern. Else, they'll be randomly assigned to an open bed.
...
{% building_link guardtower %} provide 1 bed for a Guard, while {% building_link barracks %} provide housing for many Guards. See those pages for more details.
...
Turning off the daylight cycle in-game can affect some events and internal updates unpredictably. Most notably, this includes [raids](../../source/systems/raid) and {% worker_link farmer %}, but may include things like sicknesses or the growth of children. However, this is not publicly known.
